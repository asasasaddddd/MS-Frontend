...
export const FLOW_STAGE_DEFINITIONS: readonly FlowStageDefinition[] = [
  ...
  { dimensionCode: 'business', stageCode: 'manager_check', label: '待管理员处理', tone: 'warning', order: 30, showWhenZero: false },
  ...
  { dimensionCode: 'business', stageCode: 'external_third_judge', label: '待外委检定员三次判定', tone: 'warning', order: 140, showWhenZero: false },
  ...
  { dimensionCode: 'business', stageCode: 'returned', label: '已退回', tone: 'error', order: 240, showWhenZero: false },

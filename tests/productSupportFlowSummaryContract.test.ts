...
assert.match(verifierViewSource, /buildWorkflowTaskSummary/)
assert.match(verifierViewSource, /buildWorkflowTaskSummary\(workflowTodoTasks\.value,\s*'PRODUCT_SUPPORT'\)/)

...
assert.match(component, /for="workspace-dashboard-business-filter"/)
assert.match(component, /id="workspace-dashboard-business-filter"/)
...
assert.doesNotMatch(component, /@keydown\.(enter|space)/)
...
assert.match(component, /<colgroup\b/)
assert.match(component, /dashboard-col--metric/)
assert.match(component, /dashboard-col--action/)
